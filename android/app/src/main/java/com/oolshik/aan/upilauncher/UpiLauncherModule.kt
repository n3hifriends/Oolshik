package com.oolshik.aan.upilauncher
...
class UpiLauncherModule(
  reactContext: ReactApplicationContext,
) : ReactContextBaseJavaModule(reactContext) {

  companion object {
    private const val MODULE_NAME = "OolshikUpiLauncher"
  }
  ...
  fun openApp(packageName: String, promise: Promise) {
    try {
      ...
      promise.reject("LAUNCH_FAILED", "Unable to launch $packageName: ${e.message}", e)
    }
  }
}
