...
const en = {
  oolshik: {
    ...
    feedback: {
      ...
      addDetailsRequired: "Please add a few details so we can understand better.",
      submit: "Submit",
      submitting: "Submitting…",
      thanks: "Thanks for your feedback!",
      queued: "Saved. We'll send it when you're back online.",
      error: "Something went wrong. Please try again.",
      creationPromptTitle: "Request posted",
      creationPromptBody: "How was creating your request? Your feedback helps us improve.",
      completionPromptTitle: "Task completed",
      completionPromptBody: "We'd love to hear how it went - share a quick rating below.",
      promptSkip: "Not now",
      promptGiveFeedback: "Give feedback",
      laterAlertTitle: "Feedback anytime",
      laterAlertBody:
        "You can share your feedback anytime from the Feedback section on your Profile screen.",
    },
    status: {
      open: "Open",
      pending: "Pending",
    ...
    notificationInbox: {
      ...
      emptyBodyTasks: "You'll see updates here when someone responds to your tasks.",
      emptyBodyAdmin: "You'll see messages here when the oolshik team sends an announcement.",
    ...
    profileScreen: {
      ...
      deleteAccountFailedBody: "Please try again in a moment.",
    ...
    taskDetailScreen: {
      ...
      selectReasonBody: "Please choose a reason before continuing.",
      ...
      reassignReasonNotResponding: "Helper not responding",
      reassignReasonTakingTooLong: "Taking too long",
      reassignReasonChangedMind: "Changed my mind",
      ...
      reasonForReassign: "Reason for reassigning",
    ...
    helpRequestsUnavailableScreen: {
      eyebrow: "Temporarily paused",
      title: "Help requests aren't available right now",
      defaultMessage:
        "Your account and data are safe. This feature will be back shortly - please check again.",
      retry: "Check again",
      retrying: "Checking…",
      checkingStatus: "Checking…",
      stillUnavailableStatus: "Still unavailable - last checked just now",
      offlineStatus: "Couldn't check. Please check your connection and try again.",
      contactSupport: "Contact support",
      contactSupportFailedTitle: "Couldn't reach support",
      contactSupportFailedBody: "Please email us at {{email}}",
      contactSupportFailedBodyNoEmail: "Please try again later.",
      logout: "Log out",
    },
    maintenanceScreen: {
      eyebrow: "Scheduled maintenance",
      title: "We're making oolshik better",
      defaultMessage: "oolshik is temporarily offline for maintenance. Please check back shortly.",
      expectedBack: "Expected back by {{time}}",
      retry: "Check status",
      retrying: "Checking…",
      checkingStatus: "Checking…",
      stillDownStatus: "Still under maintenance - last checked just now",
      offlineStatus: "Couldn't check. Please check your connection and try again.",
    },
    forceUpdateScreen: {
      eyebrow: "New version available",
      title: "Update oolshik to continue",
      message: "Updating keeps oolshik fast, reliable, and secure.",
      currentVersion: "Your version: {{version}}",
      minimumVersion: "Minimum required: {{version}}",
      updateNow: "Update Now",
      alreadyUpdated: "I've updated - check again",
      retrying: "Checking…",
      checkingStatus: "Checking…",
      notDetectedStatus: "Update not detected yet - finish installing, then reopen oolshik.",
      storeOpenFailedStatus: "Couldn't open the store. Please try again.",
    },
    chatScreen: {
    ...
    login: {
      ...
      phoneInfoIconLabel: "Why we ask this",
      phoneAlertTitle: "Why we ask this",
      phoneAlertBody:
        "We don't access your bank or hold your money. Matching your UPI number to your login number just lets neighbours' payments - e.g. ₹50 for a task - reach your UPI app directly. Optional, add anytime.",
    ...
    consent: {
      ...
      permissions: {
        title: "Permissions used by oolshik",
        locationSummary: "Location - Required to find and coordinate nearby help",
        notificationsSummary: "Notifications - Optional alerts about your requests",
        mediaSummary: "Camera & microphone - Optional; used only when you scan or record",
        whyWeAsk: "Why we ask?",
        sheetTitle: "Why Oolshik asks",
        locationTitle: "Location",
        locationBody: "Connects you with help in your area.",
        locationExample: "Example: Show nearby requests and add a location to your request.",
        notificationsTitle: "Notifications",
        notificationsBody: "Keeps you informed about important activity.",
        notificationsExample: "Example: Know when someone accepts or updates your request.",
        microphoneTitle: "Microphone",
        microphoneBody: "Lets you create a request using a short voice recording.",
        microphoneExample: "Example: Describe what you need instead of typing.",
        cameraTitle: "Camera",
        cameraBody: "Lets you scan payment QR codes.",
        cameraExample: "Example: Scan your UPI QR when setting up payment details.",
        privacyNote:
          "Location is accessed only while you use Oolshik. The camera and microphone are accessed only after you start a scan or recording. You can change optional permissions anytime in your device settings.",
        gotIt: "Got it",
      },
    },
    zone: {
  ...
  payment: {
    ...
    direct: {
      ...
      payMethodTitle: "How would you like to pay?",
      payMethodBody: "Choose how to send the payment.",
      payScanMethod: "Scan QR Code",
      payDirectMethod: "Pay via UPI App",
      collectMethodTitle: "How would you like to collect payment?",
      collectMethodBody: "Choose how the requester will pay you.",
      collectScanMethod: "Scan QR Code",
      collectDirectMethod: "Send Payment Request",
      ...
      profileLoadingTitle: "Please wait",
      profileLoadingBody: "We're still loading your payment profile. Try again in a moment.",
