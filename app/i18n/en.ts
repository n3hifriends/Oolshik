...
const en = {
  ...
  payment: {
    profile: {
      ...
      scanReviewTitle: "QR found — review before applying",
    ...
    direct: {
      ...
      profileRequiredTitle: "Add your payment profile first",
      profileRequiredBody:
        "To receive money directly, add your UPI ID once. You can still skip it during onboarding.",
      requesterProfileMissingTitle: "Requester isn't ready for direct payment yet",
      ...
      createFailedTitle: "Couldn't prepare direct payment",
    ...
    pay: {
      ...
      confirmPaidNameTitle: "Confirm you paid {{name}}?",
      roleYouArePaying: "You are paying {{name}}",
      roleYouReceiveFrom: "You will receive from {{name}}",
    ...
    qr: {
      ...
      mismatchTitle: "QR doesn't match saved profile",
